import { FRONT_END_URI } from "../constant/constant.js";

export const emailForgetTemplate = (token) => {
                        ...
                        >
                          ...
                          <tr>
                            <td style="padding: 0 35px">
                              ...
                              <a
                                href="testing/forget-password/${token}"
                                style="
                                  background: #20e277;
                    ...
                    <tr>
                      <td style="text-align: center">
                        <p
                          ...
                          "
                        >
                          &copy; <strong>www.sudo24.com</strong>
                        </p>
                      </td>
                    </tr>
                    <tr>
